...
public class GPUImageLevelsFilter extends GPUImageFilter {
    ...
    public GPUImageLevelsFilter() {
        this(new float[]{0.0f, 0.0f, 0.0f}, new float[]{TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE}, new float[]{TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE}, new float[]{0.0f, 0.0f, 0.0f}, new float[]{TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE});
    }
    ...
    private GPUImageLevelsFilter(float[] min, float[] mid, float[] max, float[] minOUt, float[] maxOut) {
        ...
        setMin(0.0f, TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE, 0.0f, TextTrackStyle.DEFAULT_FONT_SCALE);
    }
    ...
    public void setMin(float min, float mid, float max) {
        setMin(min, mid, max, 0.0f, TextTrackStyle.DEFAULT_FONT_SCALE);
    }
    ...
    public void setRedMin(float min, float mid, float max) {
        setRedMin(min, mid, max, 0.0f, TextTrackStyle.DEFAULT_FONT_SCALE);
    }
    ...
    public void setGreenMin(float min, float mid, float max) {
        setGreenMin(min, mid, max, 0.0f, TextTrackStyle.DEFAULT_FONT_SCALE);
    }
    ...
    public void setBlueMin(float min, float mid, float max) {
        setBlueMin(min, mid, max, 0.0f, TextTrackStyle.DEFAULT_FONT_SCALE);
    }
}
