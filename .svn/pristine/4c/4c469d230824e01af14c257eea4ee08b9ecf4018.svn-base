...
public class GPUImagePopArtFilter extends GPUImageFilter {
    ...
    public GPUImagePopArtFilter(float brightGap) {
        super(GPUImageFilter.NO_FILTER_VERTEX_SHADER, POPART_FRAGMENT_SHADER);
        this.mBrightGapAmount = brightGap;
    }
    ...
    public void setBrightGap(float gap) {
        this.mBrightGapAmount = gap;
        setFloat(this.mBrightGapLocation, this.mBrightGapAmount);
    }
}
