...
public class ConstValue {
    ...
    public static final String EXTRA_STATUS_TEXT_EDIT_INPUT = "EXTRA_STATUS_TEXT_EDIT_INPUT";
    public static final int REQUEST_CODE_EDIT_PHOTO_ACTIVITY = 0x25;
    public static final int REQUEST_CODE_TEXT_INPUTED = 0X76;
    public static final int REQUEST_CODE_SET_PICTURE_AS = 0X77;
    public static final String EXTRA_TEXT_INPUTED = "EXTRA_TEXT_INPUTED";
    ...
    public static final String EXTRA_CURRENT_COLOR_PICKER = "EXTRA_CURRENT_COLOR_PICKER";
    public static final String APP_FOLDER = "PhotoGallery";
