...
public class BetterVideoPlayer extends RelativeLayout implements IUserMethods,
    ...
    // Remove view in top if not remove after sometime toolbar will be hide
    public void onRemoveViewToolbar() {
        removeView(mToolbarFrame);
    }

    public void setHideControlPlay(boolean isHideControlPlay) {
        removeView(mControlsFrame);
    ...
    public void start() {
        ...
        mCallback.onUpdateStatePlaying(true);
    }
    ...
    public void pause() {
        ...
        if (mCallback != null) {
            mCallback.onUpdateStatePlaying(false);
        }
    }
    ...
    protected void onFinishInflate() {
        ...
        mBtnFullscreen = mControlsFrame.findViewById(R.id.btnFullscreen);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btnPlayPause) {
            ...
            mCallback.onToggleFullscreen(isFullscreen);
        }
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (mCallback != null) {
            mCallback.onSeekbarProgressChanged(progress, this);
        }
    }
    ...
    private boolean fistThrowError = false;
