...
public class GPUImageColorBalanceFilter extends GPUImageFilter {
    ...
    public GPUImageColorBalanceFilter(float[] shadows, float[] midtones, float[] highlights) {
        super(GPUImageFilter.NO_FILTER_VERTEX_SHADER, GPU_IMAGE_COLOR_BALANCE_FRAGMENT_SHADER);
        this.showdows = shadows;
        this.midtones = midtones;
        this.highlights = highlights;
        this.preserveLuminosity = true;
    }

    public GPUImageColorBalanceFilter(float[] shadows, float[] midtones, float[] highlights, boolean preserveLuminosity) {
        super(GPUImageFilter.NO_FILTER_VERTEX_SHADER, GPU_IMAGE_COLOR_BALANCE_FRAGMENT_SHADER);
        this.showdows = shadows;
        this.midtones = midtones;
        this.highlights = highlights;
