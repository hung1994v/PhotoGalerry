...
public class GPUImageMonochromeFilter extends GPUImageFilter {
    ...
    public GPUImageMonochromeFilter() {
        this(TextTrackStyle.DEFAULT_FONT_SCALE, new float[]{0.6f, 0.45f, 0.3f, TextTrackStyle.DEFAULT_FONT_SCALE});
    }
    ...
    public void onInitialized() {
        super.onInitialized();
        setIntensity(TextTrackStyle.DEFAULT_FONT_SCALE);
        setColor(new float[]{0.6f, 0.45f, 0.3f, TextTrackStyle.DEFAULT_FONT_SCALE});
    }
